...
VkPipelineVertexInputStateCreateInfo VertexInputDescription::toVertexInputInfo()
{
...
bool CPUMesh::load_from_obj(const char* filename)
{
    ...
    if (!tinyobj::LoadObj(&attrib, &shapes, &materials, &warn, filename)) {
